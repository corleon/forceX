<?php
/**
 * Template Name: Prescribers
 * Description: Recommend ForceX™ for prescribers page with form
 */
    ...
    <div class="container-custom py-12 pb-24 md:pb-32 relative z-10" style="max-width: 900px; margin: 0 auto;">
        ...
        <nav class="mb-6">
            <div class="flex justify-center">
                <ol class="flex items-center  text-base text-gray-500 bg-white px-4 py-2 rounded-full">
                    ...
                    <li class="flex items-center">
                        <span class="mx-2 text-gray-400">/</span>
                        <span class="text-gray-900 font-medium">Prescribers</span>
                    </li>
                </ol>
            </div>
        </nav>
        ...
        <div class="text-center mb-8">
            <h1 class="title-h2 mb-4">
                Recommend ForceX™ for your patients' recovery
            </h1>
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                The ForceX™ delivers iceless cold therapy combined with active compression to accelerate healing and improve mobility after surgery or injury.
            </p>
        </div>
        ...
        <div class="flex flex-wrap justify-center gap-4 mb-12">
            <div class="flex items-center gap-2" style="background-color: #FFFFFF; border-radius: 9999px; padding: 4px;">
                <div class="flex items-center justify-center" style="width: 32px; height: 32px; background-color: #F0F2F5; border-radius: 50%;">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/31.svg" alt="Improved circulation" style="width: 20px; height: 20px;">
                </div>
                <span style="font-size: 18px; color: #000000; font-weight: 500;">Improved circulation</span>
            </div>
            <div class="flex items-center gap-2" style="background-color: #FFFFFF; border-radius: 9999px; padding: 4px;">
                <div class="flex items-center justify-center" style="width: 32px; height: 32px; background-color: #F0F2F5; border-radius: 50%;">
            ...
            <div class="flex items-center gap-2" style="background-color: #FFFFFF; border-radius: 9999px; padding: 4px;">
                <div class="flex items-center justify-center" style="width: 32px; height: 32px; background-color: #F0F2F5; border-radius: 50%;">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/rehabilitation.svg" alt="Faster recovery" style="width: 20px; height: 20px;">
                </div>
                <span style="font-size: 18px; color: #000000; font-weight: 500;">Faster recovery</span>
            </div>
        </div>
        ...
        <div class="w-full bg-white p-8 md:p-12">
            ...
            <form id="prescribers-form" class="forcex-contact-form" data-form-source="prescribers">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label for="prescribers_first_name" class="block text-sm font-medium text-gray-700 mb-2 pl-4">
                            First name *
                        </label>
                        <input type="text" id="prescribers_first_name" name="first_name" required
                    ...
                    <div>
                        <label for="prescribers_last_name" class="block text-sm font-medium text-gray-700 mb-2 pl-4">
                            Last name *
                        </label>
                        <input type="text" id="prescribers_last_name" name="last_name" required
                               class="w-full px-4 focus:outline-none focus:ring-2 focus:ring-primary-500"
                               style="background-color: #EEF2F6; border-radius: 32px; height: 48px; border: none;"
                               placeholder="Your name">
                    </div>
                    <div>
                        <label for="prescribers_email" class="block text-sm font-medium text-gray-700 mb-2 pl-4">
                            Email *
                        </label>
                        <input type="email" id="prescribers_email" name="email" required
                               class="w-full px-4 focus:outline-none focus:ring-2 focus:ring-primary-500"
                               style="background-color: #EEF2F6; border-radius: 32px; height: 48px; border: none;"
                               placeholder="Email">
                    </div>
                    <div>
                        <label for="prescribers_phone" class="block text-sm font-medium text-gray-700 mb-2 pl-4">
                            Phone number *
                        </label>
                        <input type="tel" id="prescribers_phone" name="phone" required
                               class="w-full px-4 focus:outline-none focus:ring-2 focus:ring-primary-500"
                               style="background-color: #EEF2F6; border-radius: 32px; height: 48px; border: none;"
                ...
                <div id="prescribers-form-message" class="mb-6 hidden"></div>
