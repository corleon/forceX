 ...
 * Description: Rent ForceX™ for clinic page with form
 */
    ...
    <div class="container-custom py-12 pb-24 md:pb-32 relative z-10" style="max-width: 900px; margin: 0 auto;">
        ...
        <nav class="mb-6">
            <div class="flex justify-center">
                <ol class="flex items-center  text-base text-gray-500 bg-white px-4 py-2 rounded-full">
                    ...
                    <li class="flex items-center">
                        <span class="mx-2 text-gray-400">/</span>
                        <span class="text-gray-900 font-medium">Clinic</span>
                    </li>
                </ol>
            </div>
        </nav>
        ...
        <div class="text-center mb-8">
            <h1 class="title-h2 mb-4">
                Support your patients with ForceX™ in your clinic
            </h1>
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                Integrating the ForceX™ into your clinic's recovery protocols will provide your patients with effective heat, cold, and compression therapy that accelerates healing, reduces inflammation, and boosts circulation.
            </p>
        </div>
        ...
        <div class="w-full bg-white p-8 md:p-12">
            ...
            <form id="clinic-form" class="forcex-contact-form" data-form-source="clinic">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label for="clinic_first_name" class="block text-sm font-medium text-gray-700 mb-2 pl-4">
                            First name *
                        </label>
                        <input type="text" id="clinic_first_name" name="first_name" required
                    ...
                    <div>
                        <label for="clinic_last_name" class="block text-sm font-medium text-gray-700 mb-2 pl-4">
                            Last name *
                        </label>
                        <input type="text" id="clinic_last_name" name="last_name" required
                               class="w-full px-4 focus:outline-none focus:ring-2 focus:ring-primary-500"
                               style="background-color: #EEF2F6; border-radius: 32px; height: 48px; border: none;"
                               placeholder="Your name">
                    </div>
                    <div>
                        <label for="clinic_email" class="block text-sm font-medium text-gray-700 mb-2 pl-4">
                            Email *
                        </label>
                        <input type="email" id="clinic_email" name="email" required
                               class="w-full px-4 focus:outline-none focus:ring-2 focus:ring-primary-500"
                               style="background-color: #EEF2F6; border-radius: 32px; height: 48px; border: none;"
                               placeholder="Email">
                    </div>
                    <div>
                        <label for="clinic_phone" class="block text-sm font-medium text-gray-700 mb-2 pl-4">
                            Phone number *
                        </label>
                        <input type="tel" id="clinic_phone" name="phone" required
                               class="w-full px-4 focus:outline-none focus:ring-2 focus:ring-primary-500"
                               style="background-color: #EEF2F6; border-radius: 32px; height: 48px; border: none;"
                ...
                <div id="clinic-form-message" class="mb-6 hidden"></div>
