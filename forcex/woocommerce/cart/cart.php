            ...
            <div class="cart-summary-box bg-gray-50 rounded-lg p-6 sticky top-8" style="max-width: calc(100% + 20px);">
                ...
                <div class="mb-4 p-4 bg-gray-100 border border-gray-200 rounded-lg">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <h3 class="font-semibold text-gray-900 mb-1">Checkout Temporarily Unavailable</h3>
                            <p class="text-sm text-gray-700 mb-2">
                                Our checkout system is currently being updated to serve you better. 
                            </p>
                            <p class="text-sm text-gray-700">
                                Please <a href="<?php echo esc_url(home_url('/contact')); ?>" class="underline font-medium hover:text-gray-900">contact us</a> to complete your purchase, and we'll be happy to assist you.
                            </p>
                        </div>
                    </div>
                </div>
